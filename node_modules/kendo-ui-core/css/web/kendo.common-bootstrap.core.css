...
.k-split-button-arrow {
  height: -webkit-calc(1.72em + (2*4px) + 2px);
  height: calc(1.72em + (2*4px) + 2px);
  width: -webkit-calc(1.72em + (2*4px) + 2px);
  width: calc(1.72em + (2*4px) + 2px);
  padding: 4px -webkit-calc(14px/2);
  padding: 4px calc(14px/2);
}
